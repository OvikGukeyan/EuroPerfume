import { ApplicationMethod, Aromas, Brands, Classifications, Effects, Finish, Formula, Gender, Notes, PackagingFormat, PerfumeConcentration, Purpose, SkinType, Texture } from "@prisma/client";
