...
export const OrderSuccessTemplate: React.FC<Props> = ({
  ...
  <ul>
    <li>
      Bestellnummer: <strong>#EP-{orderId.toString().padStart(6, "0")}</strong>
    </li>
    <li>
  ...
  <p>
    ...
    bestätigen, und Sie informieren, sobald das Paket an den Versanddienstleister
    übergeben wurde.
  </p>
  ...
  <p>
    ...
    <br />
    • Die Lieferung dauert je nach Region 2–7 Werktage
  </p>
